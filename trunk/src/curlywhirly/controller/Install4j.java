...
{
	private static String URL = "http://bioinf.hutton.ac.uk/curlywhirly/installers/updates.xml";
		...
		Runnable r = new Runnable() {
			public void run()
			{
				try
				{
					...
					String id = URLEncoder.encode(Prefs.curlywhirlyID, "UTF-8");
					...
					String addr = "http://bioinf.hutton.ac.uk/curlywhirly/logs/curlywhirly.pl"
						+ "?id=" + id
						+ "&version=" + version
						+ "&locale=" + locale
						+ "&rating=" + "0"
